...
- Textos de interfaz en español de Chile, tono neutro y amable.
- Accesibilidad: contraste AA, áreas táctiles de 48 px, estados con color + ícono + texto.
- Mobile first. Probar siempre en viewport de 375 px.
- Construir por fases de la spec. No adelantar funciones de fase 2 o 3.